...
*/
#ifndef K32_strobedmx_h
#define K32_strobedmx_h
...
#define STROBE_PATCHSIZE 16   // Must be multiple of 4 to map to CRGBW color

class K32_strobedmx : public K32_fixture 
{
  public:
    K32_strobedmx(const int DMX_PIN[3], int addressStart) : K32_fixture(STROBE_PATCHSIZE/4)
    {
      // ADDR offset
