...
/*
USAGE: 
Modulators needs to define at least the method   uint8_t value() 

This method returns a 8bit (0->255) value generated by the modulator based on internal parameters.
